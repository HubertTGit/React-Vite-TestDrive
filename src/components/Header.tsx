...
export const Header = ({ onToggleHandler, mode }: { onToggleHandler: React.MouseEventHandler, mode: boolean }) => {
    return (
        <header className='p-10 bg-slate-200 dark:bg-slate-900 dark:text-white flex justify-between'>
            <h1>Advertising Data ETV-L</h1>
            <button onClick={onToggleHandler}>

                {
                    mode ?
                        <svg viewBox="0 0 512 512" enable-background="new 0 0 512 512" className="h-5 w-5 fill-white">
                            <g>
                                <g>
                        ...
                        :
                        <svg viewBox="0 0 512 512" enable-background="new 0 0 512 512" className=" h-5 w-5 fill-black">
                            <g>
                                <g>
